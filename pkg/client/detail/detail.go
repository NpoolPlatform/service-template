...
type handler func(context.Context, npool.TemplateDetailClient) (cruder.Any, error)
...
func withCRUD(ctx context.Context, handler handler) (cruder.Any, error) {
	...
	cli := npool.NewTemplateDetailClient(conn)

	return handler(_ctx, cli)
}

func CreateDetail(ctx context.Context, in *npool.DetailReq) (*npool.Detail, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.TemplateDetailClient) (cruder.Any, error) {
...
func CreateDetails(ctx context.Context, in []*npool.DetailReq) ([]*npool.Detail, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.TemplateDetailClient) (cruder.Any, error) {
